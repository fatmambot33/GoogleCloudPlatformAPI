...
class TestAnalytics(unittest.TestCase):
    ...
    def test_list_views(self, mock_build, mock_service_account):
        ...
        mock_management_service.management.return_value.profiles.return_value = (
            mock_profiles
        )
        mock_profiles.list.return_value.execute.return_value = {
            "items": ["view1", "view2"]
        }
        ...
        mock_profiles.list.assert_called_once_with(
